tinymce.init({
    selector: 'textarea.formulario_avulso-texteara',
    ...
    toolbar: 'undo redo | blocks fontfamily fontsize | bold italic underline strikethrough | link table mergetags | addcomment showcomments | spellcheckdialog a11ycheck | align lineheight | checklist numlist bullist indent outdent | removeformat',
    ...
    content_css: 'dark',
    menubar: false,
    entity_encoding: 'raw', // Adicione esta configuração
});
